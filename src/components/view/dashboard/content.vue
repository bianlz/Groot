                                        ...
                                        <ul class="timeline timeline-update">
                                            ...
                                            <li>
                                                <div class="timeline-badge info wow lightSpeedIn center">
                                                    <img src="static/img/authors/avatar.jpg" height="36" width="36"
                                                         class="img-circle pull-right" alt="avatar-image">
                                                </div>
                                                <div class="timeline-panel wow slideInLeft">
                                                    <div class="timeline-heading">
                                            ...
                                            <li>
                                                <div class="timeline-badge default wow lightSpeedIn center">
                                                    <img src="static/img/authors/avatar2.jpg" height="36" width="36"
                                                         class="img-circle pull-right" alt="avatar-image">
                                                </div>
                                                <div class="timeline-panel wow slideInLeft">
                                                    <div class="timeline-heading">
                                            ...
                                            <li>
                                                <div class="timeline-badge primary wow lightSpeedIn center">
                                                    <img src="static/img/authors/avatar3.jpg" height="36" width="36"
                                                         class="img-circle pull-right" alt="avatar-image">
                                            ...
                                            <li>
                                                <div class="timeline-badge info wow lightSpeedIn center">
                                                    <img src="static/img/authors/avatar4.jpg" height="36" width="36"
                                                         class="img-circle pull-right" alt="avatar-image">
                            ...
                            <div class="panel personal-chat">
                                <div class="panel-heading">
                                    <div class="panel-title"><img class="chat-image img-circle pull-left" height="36"
                                                                  width="36"
                                                                  src="static/img/authors/avatar5.jpg" alt="avatar-image">
                                ...
                                <div class="tab-pane fade in active" id="r_tab1">
                                    <div id="slim_t1">
                                        ...
                                        <ul class="list-unstyled margin-none">
                                            ...
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="#">
                                                    <img src="static/img/authors/avatar4.jpg"
                                                         class="img-circle pull-right" alt="avatar-image">
                                            ...
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="#">
                                                    <img src="static/img/authors/avatar5.jpg"
                                                         class="img-circle pull-right" alt="avatar-image">
                                            ...
                                            <li class="rightsidebar-contact-wrapper">
                                                <a class="rightsidebar-contact" href="#">
                                                    <img src="static/img/authors/avatar7.jpg"
                                                         class="img-circle pull-right" alt="avatar-image">
                                                    <i class="fa fa-circle text-xs text-muted"></i>
                                                    Cassandra
                                                </a>
                                    ...
                                    <div id="slim_t2">
                                        ...
                                        <ul class="list-unstyled m-t-15 notifications">
                                            ...
                                            <li>
                                                <a href="" class="message icon-not striped-col">
                                                    <img class="message-image img-circle"
                                                         src="static/img/authors/avatar6.jpg" alt="avatar-image">
                                            ...
                                            <li>
                                                <a href="" class="message icon-not">
                                                    <img class="message-image img-circle"
                                                         src="static/img/authors/avatar1.jpg" alt="avatar-image">
                                                    <div class="message-body">
                                            ...
                                            <li>
                                                <a href="" class="message icon-not striped-col">
                                                    <img class="message-image img-circle"
                                                         src="static/img/authors/avatar7.jpg" alt="avatar-image">
