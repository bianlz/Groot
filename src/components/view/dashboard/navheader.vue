                ...
                <ul class="nav navbar-nav">
                        ...
                        <ul class="dropdown-menu dropdown-messages table-striped">
                            ...
                            <li>
                                <a href="" class="message striped-col">
                                    <img class="message-image img-circle" src="static/img/authors/avatar7.jpg" alt="avatar-image">
                            ...
                            <li>
                                <a href="" class="message">
                                    <img class="message-image img-circle" src="static/img/authors/avatar6.jpg" alt="avatar-image">
                            ...
                            <li>
                                <a href="" class="message striped-col">
                                    <img class="message-image img-circle" src="static/img/authors/avatar5.jpg" alt="avatar-image">
                            ...
                            <li>
                                <a href="" class="message">
                                    <img class="message-image img-circle" src="static/img/authors/avatar1.jpg" alt="avatar-image">
                                    <div class="message-body">
                            ...
                            <li>
                                <a href="" class="message striped-col">
                                    <img class="message-image img-circle" src="static/img/authors/avatar.jpg" alt="avatar-image">
                                    <div class="message-body">
                                        <strong>Tony</strong>
                                        <br>
                                        Let me know when you free
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle padding-user" data-toggle="dropdown">
                            <img src="static/img/authors/avatar1.jpg" width="35" class="img-circle img-responsive pull-left"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="static/img/authors/avatar1.jpg" class="img-circle" alt="User Image">
                                <p> Addison</p>
                            </li>
                            <!-- Menu Body -->
